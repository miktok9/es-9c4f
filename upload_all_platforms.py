...
def main():
    ...
    # Spanish description - topic-relevant, no AI mentions
    description = f"""Descubre la historia fascinante de las mujeres en las civilizaciones antiguas.

Explora las leyes, las costumbres, las tradiciones y las figuras emblemáticas que marcaron la historia.

#Shorts #HistoriaDeLasMujeres #HistoriaAntigua #Educación"""
    
    tags = [
        'Historia', 'Mujeres antiguas', 'Hechos históricos',
        'Shorts', 'Reels', 'Educación', 'Cultura'
    ]
